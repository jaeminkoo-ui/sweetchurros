...
if($_POST)
{
    $to_Email       = "sweetchurrosinc@gmail.com"; // Replace with recipient email address
	$subject        = 'Message from Sweet Churros'; //Subject line for emails
    
    $host           = "smtp.1and1.com"; // Your SMTP server. For example, smtp.mail.yahoo.com
    $username       = "sweetchurrosinc@gmail.com"; //For example, your.email@yahoo.com
    $password       = "hometake"; // Your password
